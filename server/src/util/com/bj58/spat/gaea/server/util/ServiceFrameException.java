...
public class ServiceFrameException extends Exception implements Serializable {
	 ...
	 * @param cause
	 */
	public ServiceFrameException(String errorMsg, String subErrorCode, String subErrorMsg, String fromIP, String toIP, Object sdp, ErrorState state, Throwable cause) {
